...
const page = () => {
  ...
  const SapUiData = [
    {
      title: "Streamline School Management with SLRIS Edumatic", imageUrl: "/assets/images/home-banner/streamline-school.png", short_description: `Discover SLRIS Edumatic's comprehensive suite of education management solutions,
    ...
    {
      title: "Efficiency in Administration and Communication", imageUrl: "/assets/images/home-banner/efficiency.png", short_description: `Experience seamless administration with our Fee Management system and Student
    ...
    {
      title: "Innovative Teaching and Safety", imageUrl: "/assets/images/home-banner/innovative.png", short_description: `Stay at the forefront of education with our NEP-compliant Teachsmart Courses, introducing
  ...
  return (
    ...
    <>
      ...
      <div id='home' className={`md:h-screen md:bg-integrated_school bg-integrated_school_mobile backgroundPosition md:w-full h-[250px] bg-cover bg-center bg-no-repeat`} >
          ...
          <div className='md:mt-24 mt-4'>
            <div className='md:ml-10'>
              <div className='md:mb-10 mb-6'>
                <h1 className='font-semibold md:text-6xl text-xl md:mb-2 mt-8 text-transparent bg-clip-text bg-gradient-to-r from-[#152C4E] to-[#75EAE4]'>
                ...
                <p className='md:hidden block md:max-w-[525px] text-[#202124] mx-auto font-inter md:font-semibold md:text-[14px] text-[12px]'>
                  {"Your collaborator for"} <br/> {"effective performance tracking"}
                </p>
              </div>
      ...
      <div id='integrated' className='md:p-4 w-full text-center md:my-2 my-10' >

        <div className='container mx-auto md:mb-10'>

          <div className="mx-auto mb-4 max-w-[100%] text-center lg:mb-10 mt-2">
            <h2 className="font-bold text-center md:text-[25px] text-[18px] leading-[44px] md:leading-[52px] md:text-heading-3 md:mb-[60px] lg:mb-[20px]">Main Features</h2>
          </div>

          <div className="grid md:grid-cols-3 grid-cols-2 md:gap-6 gap-2 px-4">
              ...
              <Link key={list.name} href={list.link}>
                <div key={list.name} className="hover:border-[#75EAE2] border-2 bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">
                  <div className="p-2 h-40">
                    <h4 className="text-dark mb-3 text-sm font-semibold md:text-center text-left">
                      {list.name}
                    </h4>
      ...
      <div className='container md:w-full mx-auto ' >
        ...
        <div className="mx-auto text-center">
          <h2 className="text-[#0adccc] font-bold text-center md:text-[20px] text-[16px] leading-[22px] md:leading-[52px] md:text-heading-3 lg:mb-[20px]">{`"Empower Your School with SLRIS Edumatic:
      ...
      <div id='blog' className='mx-auto md:max-w-[1000px] md:mt-24 mt-16'>
        <div className='md:max-w-[1240px] mx-auto md:flex flex-col justify-center h-full'>

          <p className='text-1xl tracking-widest text-center md:mb-4 mb-2 uppercase text-black'>
            Plan
          </p>

          <div className='md:block lg:block hidden'>
            <div className='grid grid-cols-1 lg:grid-cols-3 md:grid-cols-3 gap-8 px-2'>
