...
const page = () => {
  ...
  return (
    ...
    <>
      ...
      <div id='home' className={`md:h-screen md:bg-attendance_management bg-attendance_management_mobile backgroundPosition md:w-full h-[250px] bg-cover bg-center bg-no-repeat`} >
          ...
          <div className='md:mt-24 mt-10'>
            ...
            <div className='md:ml-10'>
              <div className='md:mb-10'>
                ...
                <p className='md:block hidden md:max-w-[630px] py-2 text-[#202124] m-auto font-inter md:font-semibold md:text-[14px] text-[12px]'>
                ...
                <p className='md:hidden block md:max-w-[630px] py-2 text-[#202124] m-auto font-inter md:font-semibold md:text-[14px] text-[12px]'>
                  {"Make school fee management effective,"} <br/>
                  {"efficient, and easy with Teachmint’s Fee"} <br/>
                  {"Management Software. Automate and"} <br/>
                  {"simplify the entire edifice of the fee management process."}
                </p>
