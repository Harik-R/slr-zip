          ...
          <div className='md:mt-24 mt-10'>
            ...
            <div className='md:ml-10'>
              <div className='md:mb-10'>
                ...
                <p className='md:block hidden md:max-w-[620px] py-2 text-[#202124] m-auto font-inter md:font-semibold md:text-[14px] text-[12px]'>
                ...
                <p className='md:hidden block md:max-w-[620px] py-2 text-[#202124] mx-auto font-inter md:font-semibold md:text-[14px] text-[12px]'>
