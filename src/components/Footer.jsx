    ...
    return (
        <>
            <div className='w-full bg-white text-gray-900 px-2 border-t-[1px] border-gray-400'>
                <div className='md:max-w-[1240px] mx-auto grid md:grid-cols-3 grid-cols-1 justify-between mt-10 border-b-[1px] border-gray-400'>
                    ...
                    <div className='md:mt-2 mb-5'>
                        <h6 className='font-bold uppercase md:mt-4 mb-1'>{"INDIA"}</h6>
                        <div className='flex'>
                            <MdAddLocationAlt />
                ...
                <div className=' md:max-w-[1240px] mx-auto md:flex md:justify-between md:items-center mt-5'>
